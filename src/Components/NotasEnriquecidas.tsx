...
function NotasEnriquecidas() {
    const estilos = styles()
    return (
        <Grid container className={estilos.body} spacing={5}>
            <Grid item xs={12} sm={6} md={6} xl={12}>
                <img className={estilos.imagen} src={"https://evernote.com/c/assets/homepage/feature_mobile__es.png?e74b40fe92260908"}/>
            </Grid>
            <Grid className={estilos.primerGrid} item xs={12} sm={6} md={6} xl={12}>
                <img className={estilos.icono} src={"https://evernote.com/c/assets/homepage/rich_notes.svg?955e8d020ed22275"}></img>
...
export default NotasEnriquecidas